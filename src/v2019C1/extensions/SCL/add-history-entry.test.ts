// import { executeTableDrivenTestsChainOperations } from '@dialecte/core/test'
...
// import type { ChainTestOperation } from '@dialecte/core/test'

const xmlString = /* xml */ `<SCL></SCL>`

describe.skip('addEntryToHistory', () => {
