...
## Methods — resolved param/return (135 methods discovered)
...
| project.openDocument(…) → return                          | 924    | 0       | C1 module-noise                              |
| doc.transaction(…) param                                  | 823    | 0       | C1 module-noise                              |
| doc.prepare(…) param                                      | 820    | 0       | C1 module-noise                              |
| tx.history.addEntry(…) param                              | 499    | 0       | —                                            |
| project.queryAll(…) param                                 | 449    | 0       | C1 module-noise                              |
| project.queryFirst(…) param                               | 447    | 0       | C1 module-noise                              |
| tx.template.extractToFsd(…) param                         | 326    | 0       | C1 module-noise                              |
| tx.template.extractToAsd(…) param                         | 307    | 0       | C1 module-noise                              |
| tx.any.deepClone(…) → return                              | 233    | 2       | C1 module-noise                              |
| q.reference.resolveMappedLNode(…) → return                | 148    | 0       | C1 module-noise                              |
| tx.dataModel.extract(…) param                             | 148    | 0       | C1 module-noise                              |
...
| tx.template.ensureSubstationTemplateStructure(…) → return | 124    | 0       | —                                            |
...
| doc.prepare(…) → return                                   | 72     | 0       | C1 module-noise                              |
| q.reference.findRefsPointingTo(…) → return                | 68     | 0       | C1 module-noise                              |
| tx.reference.findRefsPointingTo(…) → return               | 68     | 0       | C1 module-noise                              |
...
| tx.template.ensureSubstationTemplateStructure(…) param    | 9      | 0       | —                                            |
...
| tx.dataModel.extract(…) → return                          | 4      | 0       | —                                            |
...
| tx.template.extractToAsd(…) → return                      | 4      | 0       | —                                            |
| tx.template.extractToFsd(…) → return                      | 4      | 0       | —                                            |
...
**Summary:** 135 methods, 26 namespace types, 144/315 rows flagged. Total 302,744 chars.
